...
import { faChevronDown, faChevronUp, faBars, faTimes, faMapMarkerAlt} from "@fortawesome/free-solid-svg-icons";
...
*/
library.add(faChevronDown, faChevronUp, faBars, faTimes, faMapMarkerAlt, faGithub, faStackOverflow, faLinkedin);
dom.watch();
